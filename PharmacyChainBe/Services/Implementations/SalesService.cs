...
namespace PharmacyChainBe.Services.Implementations
{
    public class SalesService : ISalesService
    {
        ...
        public async Task<DTOs.Response.SalesInvoiceDetailDto> GetByIdAsync(int id, CancellationToken cancellationToken = default)
        {
        ...
        private DTOs.Response.SalesInvoiceDetailDto MapToDetailDto(SalesInvoice invoice)
        {
            return new DTOs.Response.SalesInvoiceDetailDto
            {
                SalesInvoiceID = invoice.SalesInvoiceID,
                InvoiceCode = invoice.InvoiceCode,
                CustomerName = invoice.CustomerName,
